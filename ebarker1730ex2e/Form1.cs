...
namespace ebarker1730ex2e
{
    public partial class Form1 : Form
    {
        ...
        private void buttonCalc_Click(object sender, EventArgs e)
        {
            ...
            result11TextBox.Text = Convert.ToBoolean(LogicalOperations.q11(member, price, weight)).ToString();
            ...
            result12TextBox.Text = Convert.ToBoolean(LogicalOperations.q12(member, price, weight)).ToString();

            // #13
            string shipState = input13aTextBox.Text;
            string itemType = input13bTextBox.Text;
            result13TextBox.Text = Convert.ToBoolean(LogicalOperations.q13(shipState, itemType)).ToString();
        }
    }
}
