...
namespace ebarker1730ex1c
{
    public partial class frmFoodTruck : Form
    {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            txtHamburgersSubtotal.Text = (Convert.ToDecimal(txtHamburgers.Text) * 5.0m).ToString("0.00");
            txtPretaxTotal.Text = (Convert.ToDecimal(txtHotDogsSubtotal.Text) + Convert.ToDecimal(txtHamburgersSubtotal.Text)).ToString("0.00");
            txtTax.Text = (Convert.ToDecimal(txtPretaxTotal.Text) * .06875m).ToString("0.00");
